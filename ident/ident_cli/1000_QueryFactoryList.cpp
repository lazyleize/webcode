...
bool CIdentRelayApi::QueryFactoryList(CStr2Map& paramap,CStr2Map& resultmap,vector<CStr2Map>& vectmapArray,bool throwexp)
{
    CStr2Map inMap;
	...
	if(!paramap["factory_name"].empty())
	{
		str += "|factory_name:" + paramap["factory_name"];
	}
