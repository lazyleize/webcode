...
bool CIdentRelayApi::GetStandLogPath(CStr2Map& paramap,CStr2Map& resultmap,bool throwexp)
{
    CStr2Map inMap;
...
bool CIdentRelayApi::GetStandLogPathBath(const string paramap,string& result,string& strMinIOPath,bool throwexp)
{
