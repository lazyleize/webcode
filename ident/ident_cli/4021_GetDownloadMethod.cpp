...
bool CIdentRelayApi::GetDownloadMethod(CStr2Map& paramap,CStr2Map& resultmap,bool throwexp)
{
    CStr2Map inMap;
    stringstream ss;
	...
	inMap["transcode"] = TRANSCODE_TR_GETDOWNLOADTYPE;
	...
	resultmap["ap_down_flag"]="";
    resultmap["go_leve_flag"]="";
