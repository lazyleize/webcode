...
bool CIdentRelayApi::QueryTermRunList(CStr2Map& paramap,CStr2Map& resultmap,vector<CStr2Map>& vectmapArray,bool throwexp)
{
    CStr2Map inMap;
    ...
    if(!paramap["possn"].empty())
	{
		str += "|possn:" + paramap["possn"];
	}
