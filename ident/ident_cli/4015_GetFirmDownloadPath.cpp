...
bool CIdentRelayApi::GetFirmDownloadPath(const CStr2Map& paramap, CStr2Map& resultmap, bool throwexp)
{
	CStr2Map inMap;
    stringstream ss;
	...
	inMap["transcode"] = TRANSCODE_TR_APPGETFIRMDONWLOADPATH;
	...
	resultmap["pack_path"]="";
	resultmap["trans_id"]="";
	resultmap["first_down"]="";
	resultmap["time_spent"]="";
