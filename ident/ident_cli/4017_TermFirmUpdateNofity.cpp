...
bool CIdentRelayApi::TermFirmUpdateNofity(CStr2Map& paramap,CStr2Map& resultmap,bool throwexp)
{
	CStr2Map inMap;
    stringstream ss;
	...
	inMap["transcode"] = TRANSCODE_TR_APPUPDATENOTIFY;
