#include "CQueryWorkNode.h"
#include "CIdentRelayApi.h"

#define WEEKS 7
int CQueryWorkNode::IdentCommit(CReqData *pReqData, CResData *pResData)
{
    CStr2Map sessMap;
	...
	CIdentRelayApi::QueryProductSevenList(inMap,outMap,vectmapArray,true);
