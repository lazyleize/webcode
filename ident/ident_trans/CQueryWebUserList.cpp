#include "CQueryWebUserList.h"
#include "CIdentRelayApi.h"


int CQueryWebUserList::IdentCommit(CReqData *pReqData, CResData *pResData)
{
    CStr2Map sessMap;
    ...
    CIdentRelayApi::QueryWebUserList(inMap,outMap,vectmapArray,true);
    ...
    for(size_t i = 0;i < vectmapArray.size();++i)
    {
		...
		returnMap["factory_name"] = returnMap["actory_name"];
