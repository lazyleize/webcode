#include "CQueryDownRulesList.h"
#include "CIdentRelayApi.h"


int CQueryDownRulesList::IdentCommit(CReqData *pReqData, CResData *pResData)
{
    CStr2Map sessMap;
    ...
    CIdentRelayApi::QueryFirmRulesList(inMap,outMap,vectmapArray,true);
