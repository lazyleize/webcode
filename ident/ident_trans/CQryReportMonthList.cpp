#include "CQryReportMonthList.h"
#include "CIdentRelayApi.h"


int CQryReportMonthList::IdentCommit(CReqData *pReqData, CResData *pResData)
{
    CStr2Map sessMap;
    ...
    CIdentRelayApi::QueryReportMonthList(inMap,outMap,vectmapArray,true);
