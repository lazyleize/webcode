#include "CQueryFirmDownList.h"
#include "CIdentRelayApi.h"


int CQueryFirmDownList::IdentCommit(CReqData *pReqData, CResData *pResData)
{
    CStr2Map sessMap;
    ...
    CIdentRelayApi::QueryFirmDownList(inMap,outMap,vectmapArray,true);
    ...
    for(size_t i = 0;i < vectmapArray.size();++i)
    {
        ...
        returnMap["result"]   = returnMap["state_node"];
        returnMap["trans_id"] = returnMap["task_id"];
        returnMap["down_num"] = returnMap["ail_num"];
