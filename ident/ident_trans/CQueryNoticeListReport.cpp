#include "CQueryNoticeListReport.h"
#include "CIdentRelayApi.h"


int CQueryNoticeListReport::IdentCommit(CReqData *pReqData, CResData *pResData)
{
    CStr2Map sessMap;
    ...
    CIdentRelayApi::QueryMessageList(inMap,outMap,vectmapArray,true);
