#include "CQueryDataCollectionList.h"
#include "CIdentRelayApi.h"

//查询生产概况列表
int CQueryDataCollectList::IdentCommit(CReqData *pReqData, CResData *pResData)
{
    CStr2Map sessMap;
    ...
    CIdentRelayApi::QueryTermProduceList(inMap,outMap,vectmapArray,true);
    ...
    for(size_t i = 0;i < vectmapArray.size();++i)
    {
        ...
        returnMap["fac_result"] = returnMap["ac_result"];
