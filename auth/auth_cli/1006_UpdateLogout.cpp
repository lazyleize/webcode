...
bool CAuthRelayApi::UpdateUserLogout(const CStr2Map& paramap)
{
	CStr2Map inMap;
	stringstream ss;
	ss << CAuthRelayApi::RQ_UPDATE_USER_LOGOUT;
	...
	//交易码
	inMap["transcode"] = TRANSCODE_UPDATE_USER_LOGOUT;
	//inMap["uin"] = paramap["uin"];
	//inMap["loading_ip"] = paramap["loading_ip"];

	CRelayCall* m_pRelayCall = CAuthRelayApi::GetRelayObj(CAuthRelayApi::RQ_UPDATE_USER_LOGOUT) ;
