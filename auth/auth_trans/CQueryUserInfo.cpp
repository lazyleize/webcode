#include "CQueryUserInfo.h"
#include "CAuthRelayApi.h"

int CQueryUserInfo::AuthCommit(CReqData *pReqData, CResData *pResData)
{
	...
	CAuthRelayApi::QueryUserInfo(inMap["name"],outMap,true);
	CStr2Map returnMap;
		...
		pResData->SetPara("state",returnMap["state"]);
		pResData->SetPara("create_time",returnMap["create_time"]);
